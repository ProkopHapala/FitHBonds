...
_FITREQ_DIR = os.path.dirname(os.path.abspath(__file__))
_BASE_DIR   = os.path.normpath(os.path.join(_FITREQ_DIR, '..'))

def loadTypes(fEtypes=None, fAtypes=None):
    if fEtypes is None: fEtypes = os.path.join(_BASE_DIR, "data/ElementTypes.dat")
    if fAtypes is None: fAtypes = os.path.join(_BASE_DIR, "data/AtomTypes.dat")
